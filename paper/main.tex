...
Corrected, over sixty seeds, it survives only in an arena rebuilt so the fly can
resolve its structure ($+7.53\pm6.66$ health, abolished by mirroring, weakened
...
brain configuration, the same sixty seeds and controls, in the sky arena and in
an arena rebuilt so its walls carry structure at the fly's resolution (Methods).
...
\midrule
health collected & $-4.27\pm6.79$ & $\mathbf{+7.53\pm6.66}$ & $-0.67\pm7.70$ & $+4.47\pm5.96$\\
tics survived    & $-8.18\pm26.56$ & $\mathbf{+34.00\pm25.27}$ & $-13.12\pm30.48$ & $+22.63\pm26.86$\\
tiles visited    & $-0.15\pm1.76$ & $+1.58\pm2.09$ & $+1.80\pm2.46$ & $\mathbf{+3.18\pm2.10}$\\
stuck fraction   & $+0.02\pm0.05$ & $+0.03\pm0.06$ & $\mathbf{-0.12\pm0.05}$ & $\mathbf{-0.08\pm0.05}$\\
\bottomrule
\end{tabular}
\end{center}
