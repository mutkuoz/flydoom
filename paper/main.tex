...
preserves olfaction, and increases direction selectivity sevenfold. It does
...
not distinguishable by that criterion. Only locomotion statistics change:
compared directly against the frozen model on identical seeds, collisions fall
by $3.95\pm3.79$ per 1{,}000 tics and net displacement rises by $131\pm102$
units, while health collected, the task objective, does not improve. Restoring
the arithmetic a computation requires is therefore not sufficient to produce
the behaviour that computation supports.
