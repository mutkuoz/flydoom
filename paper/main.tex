...
and arm imbalance were tested and eliminated one by one. We therefore report
the motion failure as mechanistically \emph{unresolved} rather than explained.
...
such. Fifteen candidate explanations were measured and eliminated: pooling
...
and operating point, where the isolated correlator's monotonic
DSI-versus-rate curve does not reproduce in the network. The geometry, the
...
result a failure of the wired model rather than of the method.
