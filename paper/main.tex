...
produce no directional response. Three errors in the interface --- an eye map
...
the intact model and $-0.051\pm0.333$ mirrored. In the blank cylinder, where
there is nothing to fixate, individual seeds score $+0.80$, $+0.60$ and $+0.91$.
The azimuth the intact model holds is $83^\circ$ off centre on average, not
ahead.
