...
sensorimotor loop with a real-time video game, at $1.01\times$ realtime on one
consumer GPU. Nothing is trained, and the only fitted quantity is a single
...
\item A real-time closed-loop embodiment of a frozen whole-brain connectome
($1.01\times$ realtime, 139{,}255 neurons, single consumer GPU), released as
open code.
...
Wall-clock per 0.5\,ms step & ${\sim}300\,\mu$s\\
Closed-loop rate & $1.01\times$ realtime\\
\bottomrule
\end{tabular}
\end{table}
